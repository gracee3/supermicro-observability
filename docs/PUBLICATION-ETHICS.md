...
external telemetry, and non-loopback listeners. Grafana can be explicitly bound
to one exact private address for trusted direct access. Prometheus ingestion drops
